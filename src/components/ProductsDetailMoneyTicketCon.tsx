...
import { ProductsDetailMoneyTicketData } from './ProductsData';
...
const ProductsDetailMoneyTicketCon = () => {
  ...
  return (
    <>
      <Table className={classes.table}>
        ...
        <TableBody>
          {ProductsDetailMoneyTicketData.map((row) => (
            <TableRow key={row.id}>
              <TableCell align="center" className={classes.tableCell}>
      ...
      <Box className={classes.registrationBox}>
        ...
        <Grid container columnSpacing={37.5} rowSpacing={15}>
          ...
          <Grid item display="flex" alignItems="center">
            ...
            <TextField size="small" className={classes.pdNameInput} />
          </Grid>
          <Grid item display="flex" alignItems="center">
            <Typography width={100} mr={10}>
              금액
...
export default ProductsDetailMoneyTicketCon;
