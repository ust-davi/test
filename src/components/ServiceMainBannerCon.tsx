...
import { ServiceMainBannerData } from './ServiceManagementData';
...
const ServiceMainBannerCon = ({ onClickRegister }: IProps) => {
  const classes = useStyles();

  const [tabValue, setTabValue] = useState(
    ServiceMainBannerData[0].status[0].value,
  );
...
export default ServiceMainBannerCon;
