...
import { Grid, Box, Typography, Pagination, Chip } from '@mui/material';
...
const EventProceedingCon = () => {
  const classes = useStyles();
  const history = useHistory();

  const onClickButton = () => {
    history.push(`/shopManagement/event/shopmember/detail`);
  };
...
export default EventProceedingCon;
