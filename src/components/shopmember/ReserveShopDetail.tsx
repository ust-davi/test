...
const ReserveShopDetail = ({ match }: RouteComponentProps<MatchParams>) => {
    ...
    <SubLayout>
      ...
      >
        ...
        <Grid container className={classes.content}>
                  ...
                  <TableCell
                    className={clsx(
                      (item.label === '결제상태' ||
                        item.label === '예약상태') &&
                        classes.violetBold,
                      item.label === '상품' && classes.boldText,
                      classes.tableCell,
                    )}
                  >
          ...
          <Typography variant="h6">예약 로그</Typography>
          <Table className={classes.logTable} sx={{ tableLayout: 'auto' }}>
              ...
              {rows.map((row) => (
                <TableRow key={row.id}>
                  ...
                  <TableCell
                    ...
                    className={clsx(
                      classes.tableCell,
                      row.reservationStatus === '예약취소' && classes.errorText,
                    )}
                  >
          ...
          <Box width="100%" display="flex" justifyContent="flex-end" mt={25}>
            <Button
              variant="contained"
...
const useStyles = makeStyles((theme: Theme) => ({
  ...
  content: {
    padding: theme.spacing(15, 30, 12.5, 30),
  },
  table: {
