...
import ReserveHistoryCaseCon from './ReserveHistoryCaseCon';
import ReserveHistoryShopCon from './ReserveHistoryShopCon';
...
const Reservation = () => {
  ...
  const onClickListButton = () => {
    history.push('/shopManagement/reservation/shopmember');
  };
        ...
        {headTabValue === headTabMenu[0].value ? (
            ...
            <Grid container alignItems="center">
              ...
              {tabValue === caseTabMenu[0].value && (
                <>
                  ...
                  />
                  <SelectInput
                    menuItems={paymentStatusMenu}
                    className={classes.paymentStatusSelect}
                    size="small"
                    placeholder="결제상태"
                  />
                </>
          ...
          <>
            <Grid container alignItems="center">
              ...
              />
              <SelectInput
                menuItems={reserveStatusMenu}
                className={classes.reserveStatusSelect}
                size="small"
                placeholder="예약상태"
              />
              <TextField
            ...
            {tabValue === caseTabMenu[0].value ? (
              <ReserveHistoryCaseCon />
            ) : (
              <ReserveHistoryShopCon />
            )}
          </>
        )}
      </Container>
