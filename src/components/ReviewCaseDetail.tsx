          ...
          <Table className={classes.table}>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className={classes.tableCell}>
                  YYYY-MM-DD HH:MM {/* TODO: 최근 로그인 prop 필요 */}
                  <Button
                    variant="contained"
                    color="primary"
                    size="small"
                  ...
                  {[
                    {
                      id: 1,
                      label: '푸시',
                      checked: userData?.data?.app_PUSH === 'Y',
                    },
                    {
                      id: 2,
                      label: '카카오알림톡/SMS',
                      checked: userData?.data?.kakao_PUSH === 'Y',
                    },
                    {
                      id: 3,
                      label: '이메일',
                      checked: userData?.data?.email_PUSH === 'Y',
                    },
                  ].map((item) => (
                    <FormControlLabel
          ...
          <Table className={classes.table}>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className={classes.tableCell}>
                  {numberWithCommas(String(userData?.data?.point))}
                  <Button
                    variant="contained"
                    size="small"
