...
import { ReserveShopData } from './ReserveData';

const ReserveHistoryShopCon = () => {
  const classes = useStyles();
  const history = useHistory();

  const onClickAdminButton = (id: number) => {
    history.push(`/shopManagement/reservation/history/shop/detail/${id}`);
  };
...
export default ReserveHistoryShopCon;
